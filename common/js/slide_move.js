              ...
              $('.content1 a').click(function(e){
                 e.preventDefault(); //href="#" 속성을 막아주는..메소드
                  ...
                  if($(this).hasClass('link1')){   //첫번째 메뉴를 클릭했냐?   if($(this).is('#link1')){
                     value= $('#content .contentArea .sec1').offset().top-100;  // 해당 콘테츠의 상단의 거리~~
                  }else if($(this).hasClass('link2')){
                     value= $('#content .contentArea .sec2').offset().top-100; 
                  }else if($(this).hasClass('link3')){
                     value= $('#content .contentArea .sec3').offset().top-100; 
                  }
